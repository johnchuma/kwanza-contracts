...
const Page = async ({ params }) => {
  ...
  return (
    <div className="bg-slate-100 h-full">
      <div className=" max-w-4xl mx-auto text-slate-800 p-6">
        ...
        <div className="flex justify-between items-start mt-4 mb-6">
          <div className="space-y-1">
            <h1 className="text-lg 2xl:text-xl font-bold">{data.name}</h1>
        ...
        <div>
          ...
          <div className="flex flex-row space-x-0 space-y-4 md:space-y-0 md:space-x-4 mt-4">
            <div className="w-8/12 bg-white py-8 rounded-xl  p-5">
              <div className="">
                <h1 className="font-bold text-lg">Audience Age</h1>
                <p className="text-sm text-muted dark:text-white dark:text-opacity-50">
            ...
            <div className="w-4/12 bg-white py-8 rounded-xl  p-5">
              <h1 className="font-bold text-lg">Audience Gender</h1>
              <p className="text-sm text-muted dark:text-white dark:text-opacity-50">
          ...
          <div className="flex flex-row space-x-0 space-y-4 md:space-y-0 md:space-x-4 mt-4">
            <div className="w-8/12 bg-white py-8 rounded-xl  p-5">
              <div className="">
                <h1 className="font-bold text-lg">Audience Region</h1>
                <p className="text-sm text-muted dark:text-white dark:text-opacity-50">
            ...
            <div className="w-4/12 bg-white  py-8 rounded-xl  p-5">
              <h1 className="font-bold text-lg">Other information</h1>
